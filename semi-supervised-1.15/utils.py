...
def data_from_tfrecord(tf_filepath, batch_size, repeat_time, shuffle=True, alt_features='original'):
    ...
    if (alt_features == 'original'):
        ...
        data = data.map(read_tfrecord_alt_features_simple, num_parallel_calls=64)
