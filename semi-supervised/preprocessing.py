...
# after preprocessing: datasets are split up into attack data and normal data per dataset
# e.g. DoS
#   normal: 88954
#   attack: 37451
#
...
def preprocess(file_name, total_normal, total_attack):
    df = dd.read_csv(file_name, header=None, names=attributes, dtype={
        'Timestamp': float, 
        'canID': str,
        'Data0': str,
        'Data1': str,
