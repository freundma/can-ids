...
def write_tfrecord(data, filename):
    ...
    iterator = tf.compat.v1.data.make_one_shot_iterator(data).get_next()
...
def train_test_split(source_path, dest_path, DATASET_SIZE,\
    ...
    train_size = int(DATASET_SIZE * train_ratio) #37451 * 0.7 = ~26215
    train_label_size = int(train_size * train_label_ratio) # 37451 * 0.7 * 0.1 = ~2621
    val_size = int(DATASET_SIZE * val_ratio) # 37451 * 0.15
    test_size = int(DATASET_SIZE * test_ratio) # 37451 * 0.15
